...
최신 품질 리포트는 서버2의 `reports/data_quality/market=ALL/latest.json`에 저장했다. 품질 오류는 0이고, 경고 12건은 모델 학습을 막는 구조 오류가 아니라 공급자 한계 또는 추가 확인이 필요한 항목으로 분리했다.
